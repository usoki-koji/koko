...
object ServerRegistry {
    ...
    private fun skillCommand(commandStack: CommandContext<CommandSourceStack>): Int {
        ...
        val namespacePath = Koko.toPath(skill)
        val playerSkill = NeoSkillsHandler.getSkill(player, namespacePath)
            ?: return 0

        val beforeXp = playerSkill.xp

        NeoSkillsHandler.updateXp(player, namespacePath, amount * multiplier)
